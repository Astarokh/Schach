...
public class Figur {
	...
	public Figur(int bewegungsmuster, boolean aktiv, String name, int figurID, String anzeigename, int team) {
	...
	public static Figur[] schachFigurenSetErstellen() {
		...
		for (int i = 0; i < 8; i++) {											//schachFigurenSet[0]-schachFigurenSet[7] 			--> Bauern Spieler 1
			schachFigurenSet[i] = new Figur(1, true, "Bauer", i, "B-1", 1);
		}
		
		schachFigurenSet[8] = new Figur(2, true, "Turm", 8, "T-1", 1);				//schachFigurenSet[8]-schachFigurenSet[9] 		--> Türme Spieler 1
		schachFigurenSet[9] = new Figur(2, true, "Turm", 9, "T-1", 1);	
		
		schachFigurenSet[10] = new Figur(3, true, "Springer", 10, "S-1", 1);			//schachFigurenSet[10]-schachFigurenSet[11] 	--> Springer Spieler 1
		schachFigurenSet[11] = new Figur(3, true, "Springer", 11, "S-1", 1);
		
		schachFigurenSet[12] = new Figur(4, true, "Laeufer", 12, "L-1", 1);			//schachFigurenSet[12]-schachFigurenSet[13] 	--> Laeufer Spieler 1
		schachFigurenSet[13] = new Figur(4, true, "Laeufer", 13, "L-1", 1);
		
		schachFigurenSet[14] = new Figur(5, true, "Dame", 14, "D-1", 1);				//schachFigurenSet[14]							--> Dame Spieler 1
		
		schachFigurenSet[15] = new Figur(6, true, "Koenig", 15, "K-1", 1);			//schachFigurenSet[15]							--> Koenig Spieler 1
		
		
		
		for (int i = 16; i < 24; i++) {											//schachFigurenSet[16]-schachFigurenSet[23] 			--> Bauern Spieler 2
			schachFigurenSet[i] = new Figur(1, true, "Bauer", i, "B-2", 2);
		}
		
		schachFigurenSet[24] = new Figur(2, true, "Turm", 24, "T-2", 2);				//schachFigurenSet[24]-schachFigurenSet[25] 	--> Türme Spieler 2
		schachFigurenSet[25] = new Figur(2, true, "Turm", 25, "T-2", 2);	
		
		schachFigurenSet[26] = new Figur(3, true, "Springer", 26, "S-2", 2);			//schachFigurenSet[26]-schachFigurenSet[27] 	--> Springer Spieler 2
		schachFigurenSet[27] = new Figur(3, true, "Springer", 27, "S-2", 2);
		
		schachFigurenSet[28] = new Figur(4, true, "Laeufer", 28, "L-2", 2);			//schachFigurenSet[28]-schachFigurenSet[29] 	--> Laeufer Spieler 2
		schachFigurenSet[29] = new Figur(4, true, "Laeufer", 29, "L-2", 2);
		
		schachFigurenSet[30] = new Figur(5, true, "Dame", 30, "D-2", 2);				//schachFigurenSet[30]							--> Dame Spieler 2
		
		schachFigurenSet[31] = new Figur(6, true, "Koenig", 31, "K-2", 2);			//schachFigurenSet[31]							--> Koenig Spieler 2
		
		schachFigurenSet[32] = new Figur(0, false, "leer", 99, " ", 99);			//schachFigurenSet[32]							--> Platzhalter leerfeld!
		
		return schachFigurenSet;
	}
	
	public static void spielzug(Spielbrett spielbrett, Figur[] schachFigurenSet, int team) {
		
		//Auswahl der zu ziehenden Figur und Fehler anfangen
		Figur gewaehlteFigur = new Figur(0, false, "Platzhalter", 99, "PH", 99);
		...
		while(fehleingabe) {
			...
			zielFeldInt[1] = BewegungsMuster.charZahlZuZahl(zielFeldChar);
				...
				if ((zielFeldInt[0] == 9) || (zielFeldInt[1] == 9)) {
					...
					if (BewegungsMuster.spielzugUeberpruefung(gewaehlteFigur, gewaehltesFeldInt, zielFeldInt, spielbrett, team)) {
						fehleingabe=false;
						...
						//ziehen der gewaehlten Figur auf das gewaehlte Feld und auffüllen des verlassenen Feldes mit der Platzhalter-Figur
